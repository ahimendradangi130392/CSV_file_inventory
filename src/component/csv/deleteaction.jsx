...
const DeleteAction = ({ row, deleteRow }) => {
  console.log("row", row);
  ...
  return (
    <div style={{ position: "relative" }}>
      <button
        // onClick={() => handleClickOpenDelete(val, index, jsonData)}
        onClick={(e) => setIsView(true)}
        style={{ cursor: "ponter" }}
      >
        <svg
      ...
      {isView ? (
        <div className="delete-btn-popup">
          ...
          <div>
            ...
            <button onClick={() => setIsView(false)}>No</button>
          </div>
        </div>
      ) : (
        ""
